      ...
      <main className="relative z-10 px-6 md:px-8 xl:px-10 2xl:px-14 pt-6 pb-10 flex flex-col min-h-[calc(100vh-64px)]">
        ...
        >
          ...
          >
            ...
            <span className="hidden sm:inline">Accident Management</span>
            <span className="sm:hidden">Accidents</span>
          </motion.button>
        </motion.div>
                                      ...
                                      <button
                                        ...
                                        onClick={() =>
                                          openConfirmation({
                                            ...
                                            message: `Reject registration for ${pu.username}?`,
                                            buttonText: "Reject",
                                            danger: true,
                                            action: () =>
                                              handleDecision(
                                      ...
                                      <button
                                        ...
                                        onClick={() =>
                                          openConfirmation({
                                            ...
                                            message: `Approve registration for ${pu.username}?`,
                                            buttonText: "Approve",
                                            action: () =>
                                              handleDecision(
                                                pu.id,
